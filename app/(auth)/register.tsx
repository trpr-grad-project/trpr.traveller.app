    ...
    try {
      ...
      if (response.otpId) {
        router.push({
          ...
          params: { otpId: response.otpId, phone },
        });
      }
    } catch (error: any) {
      const errorMessage =
    ...
    >
      <View className="flex flex-col gap-5 pb-8">
            ...
            <View className="relative flex w-full flex-col">
              <View className="relative flex w-full flex-row items-center">
                ...
                <MaterialIcons
                  name="person"
                  size={24}
                  color={errors.firstName ? "#EF4444" : "#4F4F4F"}
            ...
            <View className="relative flex w-full flex-col">
              <View className="relative flex w-full flex-row items-center">
                ...
                <MaterialIcons
                  name="person"
                  size={24}
                  color={errors.lastName ? "#EF4444" : "#4F4F4F"}
                  style={{ position: "absolute", left: 16 }}
                />
              </View>
              {errors.lastName && (
          ...
          <View className="relative flex w-full flex-col">
            <View className="relative flex w-full flex-row items-center">
              ...
              <MaterialIcons
                name="phone"
                size={24}
                color={errors.phone ? "#EF4444" : "#4F4F4F"}
                style={{ position: "absolute", left: 16 }}
              />
            </View>
            {errors.phone && (
          ...
          <View className="relative flex w-full flex-col">
            <View className="relative flex w-full flex-row items-center">
              ...
              <MaterialIcons
                name="lock"
                size={24}
                color={errors.confirmPassword ? "#EF4444" : "#4F4F4F"}
                style={{ position: "absolute", left: 16 }}
              />
              <TouchableOpacity
        ...
        <View className="mb-8 flex flex-row justify-between gap-4">
          {/* Google */}
          <TouchableOpacity className="flex h-14 flex-1 items-center justify-center rounded-xl border border-neutral-light dark:border-neutral-dark/50 bg-white dark:bg-neutral-dark">
